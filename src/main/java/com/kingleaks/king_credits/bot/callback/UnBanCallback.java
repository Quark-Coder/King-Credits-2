...
public class UnBanCallback implements CallbackQueryHandler{
    ...
    public void handle(CallbackQuery callbackQuery) {
        ...
        telegramUsersService.unBanUser(userId);

        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(chatId);
        sendMessage.setText("Пользователь разбанить");
