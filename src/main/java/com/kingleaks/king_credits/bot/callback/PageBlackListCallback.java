...
public class PageBlackListCallback implements CallbackQueryHandler{
    ...
    public void handle(CallbackQuery callbackQuery) {
        ...
        if (list != null) {
            ...
            previousPageButton.setCallbackData("PAGE_BANNED" + (page - 1)); // Предыдущая страница

            InlineKeyboardButton nextPageButton = new InlineKeyboardButton();
            nextPageButton.setText("➡️ Вперед");
            nextPageButton.setCallbackData("PAGE_BANNED" + (page + 1)); // Следующая страница
